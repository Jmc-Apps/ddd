const CACHE_NAME='ddd-stats-recorder-v1-33-platform-branding';
const FILES=[
 './',
 './index.html',
 './goalie_stats_recorder_v1_33.html',
 './manifest.webmanifest',
 './manifest.webmanifest?v=1.33',
 './assets/d_heat_map.png',
 './assets/goal_box_heat_map.png',
 './assets/ddd-banner-v1-33.png',
 './assets/ddd-logo-v1-33.png',
 './assets/ddd-app-icon-master-v1-33.png',
 './icon-192.png',
 './icon-512.png',
 ...
 './icon-192-v1-33.png',
 './icon-512-v1-33.png',
 './apple-touch-icon-v1-33.png',
 './favicon-32-v1-33.png'
];
